...
var (
	...
	ErrAlreadyValidated = &AppError{Code: "ALREADY_VALIDATED", Message: "You have already validated this post", HTTPStatus: http.StatusConflict}
	ErrNotValidated     = &AppError{Code: "NOT_VALIDATED", Message: "You have not validated this post", HTTPStatus: http.StatusBadRequest}
	ErrAlreadyRespected = &AppError{Code: "ALREADY_RESPECTED", Message: "You have already respected this post", HTTPStatus: http.StatusConflict}
	ErrNotRespected     = &AppError{Code: "NOT_RESPECTED", Message: "You have not respected this post", HTTPStatus: http.StatusBadRequest}
)
